...
(function ($) {
    ...
    $('.modal').on('shown.bs.modal', function (e) {
        // $('.product-details-images').slick('setPosition');
    }) 
    ...
    //         $( "#min-price" ).val('' + ui.values[ 0 ]+'.000' );
    //         $( "#max-price" ).val('' + ui.values[ 1 ]+'.000' );
    //     }
    // });
    // $( "#min-price" ).val('' + $( "#price-slider" ).slider( "values", 0 )+'.000');   
    // $( "#max-price" ).val('' + $( "#price-slider" ).slider( "values", 1 )+'.000'); 
